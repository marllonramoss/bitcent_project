...
const Slogan = () => {
    ...
    const renderizarFrase = () => {        
        return (
            <div className={`
                flex flex-col items-center md:items-start text-4xl lg:text-6xl text-white font-light
            `}>
                <div className='flex gap-2.5'>
                    <div className={`relative`}>
                        <span className={`absolute bottom-1 left-0 w-full border-b-8 border-purple-500 -rotate-2`}></span>
...
return (
    <div className="flex flex-col justify-center gap-5">
        ...
        <div className="flex justify-center sm:justify-start items-center gap-2">
            ...
            `}>
                <IconVideo stroke={1} />
                <Link href="https://www.youtube.com/watch?v=078OxawqNLI" target='_blank'>
                <span className="font-thin md:text-sm text-base">

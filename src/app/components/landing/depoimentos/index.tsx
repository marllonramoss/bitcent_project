...
const Depoimentos = () => {
  return (
    <Area id='depoimentos' className='bg-gradient-to-r from-black via-zinc-900 to-black
            py-10 sm:py-20 scroll-smooth'>
      <div className='flex flex-col justify-center items-center'>
        <h2 className='font-thin text-zinc-600 text-2xl sm:text-4xl mb-11'>
            As pessoas estao dizendo...
        </h2>
      </div>
